...
(function () {
  ...
  const VAR_DEFS = {
    ...
    'peak_xfactor':         { name: '골반-상체 최대 분리각', unit: '°', polarity: 'higher', cat: 'TRANSFER', hint: '★ v0.63 코칭 언어: X-factor 최대값. 다리 들기→앞발 착지 사이 골반과 상체 어긋남 — 클수록 회전 stretch loading 큼' },
    'fc_xfactor':           { name: '착지 시점 골반-상체 분리각', unit: '°', polarity: 'higher', cat: 'TRANSFER', hint: '★ v0.63 코칭 언어: X-factor at FC. 디딤발 닿는 순간의 분리 각도 — 회전 시작 직전 stretch 자세' },
    ...
    'peak_trunk_CounterRotation': { name: '와인드업 골반 역회전', unit: '°', polarity: 'higher', cat: 'LEAK', hint: '★ v0.63 코칭 언어: Counter-rotation. 와인드업 시 골반이 반대방향으로 돌아 미는 자세 — 작으면 loading 부족' },
    ...
    // ── 관절 만든 힘 / 흡수한 힘 ──
    'shoulder_W_pos':   { name: '어깨가 만든 가속 힘', unit: 'J', polarity: 'higher', cat: 'OUTPUT', hint: '공을 던질 때 어깨가 만든 힘' },
    'shoulder_W_neg':   { name: '어깨가 흡수한 힘', unit: 'J', polarity: 'lower', cat: 'LEAK', hint: '릴리스 후 어깨가 멈춰주는 힘' },
    'shoulder_absorption_ratio': { name: '어깨 흡수/가속 비율', unit: 'ratio', polarity: 'absolute', cat: 'LEAK', hint: '~1.0 정상 (만든 만큼 멈춤)' },
    'elbow_W_pos':      { name: '팔꿈치가 만든 가속 힘', unit: 'J', polarity: 'higher', cat: 'OUTPUT', hint: '팔꿈치 펴는 힘' },
    'elbow_W_neg':      { name: '팔꿈치가 흡수한 힘', unit: 'J', polarity: 'lower', cat: 'LEAK', hint: '브레이크 역할 (큰 값 정상)' },
    'elbow_absorption_ratio': { name: '팔꿈치 흡수/가속 비율', unit: 'ratio', polarity: 'absolute', cat: 'LEAK', hint: '~2.0 정상 (브레이크가 가속의 2배 = 통로 역할)' },
    'trail_hip_W_pos':  { name: '축발 골반이 만든 힘', unit: 'J', polarity: 'higher', cat: 'OUTPUT', hint: '뒷발 골반의 회전 power' },
    'lead_hip_W_pos':   { name: '디딤발 골반이 만든 힘', unit: 'J', polarity: 'higher', cat: 'OUTPUT', hint: '앞발 골반의 회전 power' },
    'lead_knee_W_pos':  { name: '디딤발 무릎이 만든 힘', unit: 'J', polarity: 'higher', cat: 'OUTPUT', hint: '★ 앞다리 블로킹 파워' },

    // ── Phase C: ETE — 분절 간 에너지 전달 ──
    'dE_pelvis_KH_FC':  { name: '셋업~앞발 착지 골반 에너지 변화', unit: 'J', polarity: 'higher', cat: 'TRANSFER', hint: '골반이 받은 힘' },
    'dE_trunk_KH_FC':   { name: '셋업~앞발 착지 몸통 에너지 증가', unit: 'J', polarity: 'higher', cat: 'TRANSFER', hint: '하체에서 몸통으로 들어온 힘 (양수=잘 받음)' },
    'dE_trunk_FC_BR':   { name: '앞발 착지~릴리스 몸통 에너지 변화', unit: 'J', polarity: 'lower', cat: 'TRANSFER', hint: '음수 = 몸통이 잃은 힘 (팔로 넘김 = 정상)' },
    'dE_arm_FC_BR':     { name: '앞발 착지~릴리스 팔 에너지 증가', unit: 'J', polarity: 'higher', cat: 'TRANSFER', hint: '팔이 받은 힘 (몸통에서 넘어온 양)' },
    'W_hip_pos_KH_FC':  { name: '셋업~앞발 착지 양 골반이 만든 힘', unit: 'J', polarity: 'higher', cat: 'OUTPUT', hint: '하체 추진 에너지 발생' },
    'trunk_loss_FC_BR': { name: '앞발 착지~릴리스 몸통 손실 에너지', unit: 'J', polarity: 'higher', cat: 'TRANSFER', hint: '몸통이 팔로 넘긴 힘의 양 (절대값)' },
    'ETE_pelvis_to_trunk': { name: '★ 골반→몸통 힘 전달율', unit: 'ratio', polarity: 'higher', cat: 'TRANSFER', hint: '골반이 만든 힘 중 몸통으로 넘어간 비율 (0.5+ 우수)' },
    'ETE_trunk_to_arm':    { name: '★ 몸통→팔 힘 전달율', unit: 'ratio', polarity: 'higher', cat: 'TRANSFER', hint: '몸통이 잃은 힘 중 팔로 넘어간 비율 (0.5+ 우수)' },
    'ELI_segment_pelvis_trunk': { name: '골반→몸통 힘 손실율', unit: 'ratio', polarity: 'lower', cat: 'LEAK', hint: '1 − 전달율 (낮을수록 좋음)' },
    'ELI_segment_trunk_arm':    { name: '몸통→팔 힘 손실율', unit: 'ratio', polarity: 'lower', cat: 'LEAK', hint: '1 − 전달율 (낮을수록 좋음)' },
  ...
  const ELI_AREAS = [
    { id: 'lower_drive',  name: '하체 추진',          weight: 18,
      mech_idx: 0,
      desc: '축발 추진력 · 무게중심 속도 · 골반 회전 에너지',
      leak_when_low: '추진 출력 부족 (Generation — drive impulse 약함)' },
    { id: 'lead_block',   name: '앞다리 블로킹',      weight: 22,
      mech_idx: 1,
      desc: '디딤발 브레이킹 · 수직 지면반력 · 무릎 회전 에너지',
      leak_when_low: '브레이킹 부족 (Transmission — 전방 이동을 회전으로 전환 못함)' },
    { id: 'pelvis_trunk', name: '골반-몸통 연결',    weight: 15,
      mech_idx: 2,
      desc: '골반→몸통 전달율 · 골반 감속 · 골반-상체 분리각',
      leak_when_low: '전달 약함 (Transmission — 골반 회전 후 상체 조기 회전 또는 분리 부족)' },
    { id: 'trunk_power',  name: '몸통 파워',          weight: 15,
      mech_idx: 3,
      desc: '몸통 회전 속도 · 앞기울기 · 분절 속도 증가',
      leak_when_low: '몸통 출력·전달 부족 (Generation+Transmission — 회전속도·굴곡속도 모두 약함)' },
    { id: 'arm_transfer', name: '팔 전달',            weight: 15,
      mech_idx: 4,
      desc: '몸통→팔 전달율 · 최대 외회전 타이밍 · 어깨/팔꿈치 회전 에너지',
      leak_when_low: '팔 가속 약함 (Transmission — 팔 속도 피크 순서·증폭 부족)' },
    { id: 'load_eff',     name: '부하 대비 효율',     weight: 15,
      from_injury: true,
      desc: '관절 흡수/가속 비율 · 팔꿈치 외반 토크/속도 — 팔 부담 모니터',
      leak_when_low: '팔 보상형 투구 가능성 (팔꿈치 부담 ↑)' },
  ];
